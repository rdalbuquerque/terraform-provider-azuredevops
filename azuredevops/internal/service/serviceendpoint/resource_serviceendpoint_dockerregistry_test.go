...
func TestServiceEndpointDockerRegistry_ExpandFlatten_Roundtrip(t *testing.T) {
	...
	flattenServiceEndpointDockerRegistry(resourceData, &serviceEndpointWithValidation{endpoint: &dockerRegistryTestServiceEndpoint}, dockerRegistryTestServiceEndpointProjectID)
