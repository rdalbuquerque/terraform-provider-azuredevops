...
func TestServiceEndpointKubernetesForAzureSubscriptionExpandFlattenRoundtrip(t *testing.T) {
	...
	flattenServiceEndpointKubernetes(resourceData, &serviceEndpointWithValidation{endpoint: kubernetesTestServiceEndpointForAzureSubscription}, kubernetesTestServiceEndpointProjectID)
...
func TestServiceEndpointKubernetesForKubeconfigExpandFlattenRoundtrip(t *testing.T) {
	...
	flattenServiceEndpointKubernetes(resourceData, &serviceEndpointWithValidation{endpoint: kubernetesTestServiceEndpointForKubeconfig}, kubernetesTestServiceEndpointProjectID)
...
func TestServiceEndpointKubernetesForServiceAccountExpandFlattenRoundtrip(t *testing.T) {
	...
	flattenServiceEndpointKubernetes(resourceData, &serviceEndpointWithValidation{endpoint: kubernetesTestServiceEndpointForServiceAccount}, kubernetesTestServiceEndpointProjectID)
